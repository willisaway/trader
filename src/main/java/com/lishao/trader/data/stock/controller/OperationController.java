package com.lishao.trader.data.stock.controller;
...
import com.lishao.trader.data.stock.download.DownloadKLine15F;
import com.lishao.trader.data.stock.download.DownloadKLine30F;
import com.lishao.trader.data.stock.download.DownloadKLine60F;
import com.lishao.trader.data.stock.download.DownloadKLineD;
import com.lishao.trader.data.stock.download.DownloadKLineM;
import com.lishao.trader.data.stock.download.DownloadKLineW;
...
public class OperationController {
	...
	@Resource
	DownloadKLineW downloadKLineW;
	@Resource
	DownloadKLineM downloadKLineM;
	@Resource
	DownloadKLine15F downloadKLine15F;
	@Resource
	DownloadKLine30F downloadKLine30F;
	@Resource
	DownloadKLine60F downloadKLine60F;
	@Resource
